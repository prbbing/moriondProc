...
comprehensive sedicated DM search programs, primarily in the following categories: 

\begin{itemize}
\item Mono-X Signature: DM candidates are produced in association with another detectable Standard Model (SM) physics object (X). The non-interacting DM candidates give rise to a sizable missing transverse energy ($E_\textrm{T}^{\textrm{miss}}$). The detectable physics object can be a jet, photon, $Z$ boson or Higgs boson, etc.  
\item Resonance Signature: The mediator coupled to DM candidates is produced resonantly, decaying to SM particles to form a peak in the invariant mass spectrum. The SM pariticles can be a pair of jets, leptons or bosons, etc. 
\item Associated Production with Heavy Flavor Quarks:
\item Higgs Portal: 
\item Supersymmetry Searches: 
\end{itemize}    
