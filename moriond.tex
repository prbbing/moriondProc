...
\item Higgs Portal: DM candidates are decay products of the Higgs boson. There is a sizable $E_\textrm{T}^{\textrm{miss}}$ recoiled against the visible physics objects which depends on the production mode of the Higgs boson such as the vecotr boson fusion (VBF). 
\end{itemize}    
...
innovative analysis techniques such as VBF + $E_\textrm{T}^{\textrm{miss}}$ +
