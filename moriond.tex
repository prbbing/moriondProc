...
\begin{itemize}
\item Mono-X Signature: DM candidates are produced in association with another detectable Standard Model (SM) physics object (X). The non-interacting DM candidates give rise to a sizable missing transverse energy ($E_\textrm{T}^{\textrm{miss}}$). The detectable physics object can be a jet, photon, $Z$ boson or Higgs boson.  
...
The above categories have been probed systematically by both experiments 
